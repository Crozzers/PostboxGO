...
device=phone &&
    ...
    for file in $(adb shell "ls /storage/emulated/0/Pictures/pbg/$device*.png"); do adb pull $file docs/images/autocapture/; done &&
    for file in $(adb shell "ls /storage/emulated/0/Pictures/pbg/*.png" | grep -Ev "/pbg/$device"); do adb pull $file docs/images/; done
```
